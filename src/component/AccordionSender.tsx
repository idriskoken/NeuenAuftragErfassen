...
var sender: CompanyType = createEmptyCompany();
var filteredContactPers: ContactPersonType;
var dateStart: Date;
var dateEnd: Date; 

export function getSender(){
  return { sender, filteredContactPers, dateStart, dateEnd}
}

class AccordionSender extends React.Component<Props, State> {
  constructor(props: Props) {
   ...
   filterCompanyInfos = (placeHolder: string) =>{
    ...
    sender = this.state.filteredCompanyInfos
...
export default AccordionSender;